                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                <h6 class="mb-4">Add User List</h6>
                                ...
                                <form action="EditUserServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputRepassword1" class="form-label">Repassword</label>
                                        <input name="repassword" type="password" class="form-control" id="exampleInputRepassword1">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Role</label>
                                        <select name="role" class="form-control">
                                            <option <c:if test="${user.role == 'user'}"></c:if> value="user">user</option>
                                            <option <c:if test="${user.role == 'admin'}" ></c:if> value="admin">admin</option>
                                        </select>
                                    </div>
