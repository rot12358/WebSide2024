<%-- 
    Document   : sidebar
    Created on : Sep 22, 2024, 10:40:12 PM
    Author     : Admin
--%>
...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th me-2"></i></i>Categories</a>
                <div class="dropdown-menu bg-transparent border-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-chart-bar me-2"></i>Product</a>
                <div class="dropdown-menu bg-transparent border-0">
