                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Order Status</th>  <!-- New column for status -->
                                ...
                                <tr>
                                    ...
                                    <th scope="row">
                                        <div class="d-flex align-items-center">
                                            <img src="${orderItem.product.thumbnail}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                        </div>
                                    </th>
                                    <td>
                                        <p class="mb-0 mt-4">${orderItem.product.name}</p>
                                    </td>
                                    <td>
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <a href="CheckoutServlet" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4">Proceed Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
