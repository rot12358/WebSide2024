...
public class ProductImpl implements ProductDao {
    ...
    public List<Product> filter(int categoryId, String propertyName, String order) {
        List<Product> proList = new ArrayList<>();
        // Validate the propertyName and order to prevent SQL injection
        String validProperty = propertyName.equals("name") || propertyName.equals("price") || propertyName.equals("created_at") ? propertyName : "name";
        String validOrder = order.equalsIgnoreCase("asc") || order.equalsIgnoreCase("desc") ? order : "asc";

        String sql = "SELECT * FROM PRODUCTS WHERE category_id = ? ORDER BY " + validProperty + " " + validOrder;
